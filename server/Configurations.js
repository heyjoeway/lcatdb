...
class Configurations {
    ...
    static find(cid, success, failure, reqs) {
        function fail(error) {
    ...
    static getSensorList(configuration, success, failure, reqs) {
        function fail(error) {
    ...
    static new(user, success, failure) {
        function fail(error) {
        ...
        configurations.save(newConfiguration, (error, result) => {
            if (error) return fail({
                "errorName": "save",
    ...
    */
    ...
    static edit(ctx, success, failure) {
        ...
        new Chain(function() {
            ...
            Configurations.canAddSensorMulti(user, configuration, edit.sensors,
    ...
    static canAddSensor(user, configuration, sid, success, failure) {
        function fail(error) {
    ...
    static canAddSensorMulti(user, configuration, sidArray, success, failure) {
        function fail(error) {
        ...
        sidArray.forEach(sid => {
            Configurations.canAddSensor(user, configuration, sid,
                () => {
                    if (hasFailed) return;
                    responsesLeft--;
    ...
    static canEdit(user, configuration) {
    ...
    static addSensor(user, cid, sid, success, failure) {
        function fail(error) {

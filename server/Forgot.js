...
class Forgot {
    ...
    static createRequest(email, callback) {
        function fail(error) {
        ...
        new Chain(function() {
            ...
            Forgot.emailRequest(data.user, randomId, succeeded => {
                if (succeeded) return;
    ...
    static removeRequest(fid, success, failure) {
        function fail(error) {
            Winston.warn(
    ...
    static find(fid, success, failure) {
        function fail(error) {
        ...
        forgotDb.findOne(filter, (error, forgot) => {
            ...
            if (forgot.expiration < (new Date()).getTime()) {
                ...
                return Forgot.removeRequest(fid);
            }
    ...
    static useRequest(fid, password, success, failure) {
        function fail(error) {
